...
由于本片为老胶片拷贝转录，存在画面泛红现象，这是胶片年代久远导致的色彩衰减问题：
...
- 调整白平衡：降低红色通道增益
- 色彩校正：增加青色/蓝色通道
- 参数建议：红色-10到-20，蓝色+5到+15
- 使用专业软件如DaVinci Resolve进行颜色分级
            ...
            settings: [
                ...
                },
                {
                    ...
                    selector: [
                        ...
                        {
                            html: '减红增蓝',
                            value: 'hue-rotate(10deg) saturate(0.9)',
                        },
                        {
                            html: '强力去红',
                            value: 'hue-rotate(15deg) saturate(0.8) contrast(1.1)',
                        },
                        {
                            html: '冷色调',
                            value: 'hue-rotate(20deg) saturate(0.85) brightness(1.05)',
                        },
                    ],
                    onSelect: function (item, art) {
                        const video = art.template.$video;
                        video.style.filter = item.value === 'none' ? '' : item.value;
                        return item.html;
                    },
                },
            ],
