...
<div id="video-filters" style="width: 100%; max-width: 800px; margin: 10px auto; padding: 15px; background: #f5f5f5; border-radius: 8px;">
    ...
    <div style="margin-top: 15px;">
        ...
        <button onclick="applyOldFilmFix()" style="padding: 8px 15px; margin-right: 10px; background: #3498db; color: white; border: none; border-radius: 4px; cursor: pointer;">老胶片增强</button>
        <button onclick="applyColorBalance()" style="padding: 8px 15px; background: #2ecc71; color: white; border: none; border-radius: 4px; cursor: pointer;">色彩平衡</button>
    </div>
</div>
...
<script>
    ...
    function applyRedFix() {
        // 针对胶片泛红的预设调整
        const values = {
            brightness: 105, contrast: 110, saturate: 85, hue: -15,
            gamma: 1.1, temperature: 5500, exposure: 0.2, shadow: 10,
            red: 75, green: 105, blue: 120, sharpen: 15, blur: 0.2
        };
